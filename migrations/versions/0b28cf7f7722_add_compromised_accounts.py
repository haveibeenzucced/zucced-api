...
def upgrade():
    helper.execute(bind=op.get_bind(), filename="add_compromised_accounts/upgrade.sql")

def downgrade():
    helper.execute(bind=op.get_bind(), filename="add_compromised_accounts/downgrade.sql")
